export const envars: { [key: string]: string } = {
	TRAEFIK_ACCESSLOG: 'Access log settings. (Default: ```false```)',
	...
	'TRAEFIK_ACCESSLOG_FIELDS_HEADERS_NAMES_<NAME>': 'Override mode for headers',

	'TRAEFIK_ACCESSLOG_FIELDS_NAMES_<NAME>': 'Override mode for fields',
	...
	TRAEFIK_API_DASHBOARD: 'Activate dashboard. (Default: ```true```)',
	...
	TRAEFIK_HOSTRESOLVER: 'Enable CNAME Flattening. (Default: ```false```)',
	...
	TRAEFIK_LOG: 'Traefik log settings. (Default: ```false```)',
	...
	TRAEFIK_LOG_LEVEL: 'Log level set to traefik logs. (Default: ```ERROR```)',
	...
	TRAEFIK_METRICS_INFLUXDB_PASSWORD: 'InfluxDB password (only with http).',
	...
	TRAEFIK_METRICS_INFLUXDB_USERNAME: 'InfluxDB username (only with http).',
	...
	TRAEFIK_METRICS_PROMETHEUS_ENTRYPOINT: 'EntryPoint (Default: ```traefik```)',
	...
	TRAEFIK_PING: 'Enable ping. (Default: ```false```)',

	TRAEFIK_PING_ENTRYPOINT: 'EntryPoint (Default: ```traefik```)',

	TRAEFIK_PING_MANUALROUTING: 'Manual routing (Default: ```false```)',
	...
	TRAEFIK_PROVIDERS_CONSULCATALOG_ENDPOINT_TLS_CA: 'TLS CA',

	TRAEFIK_PROVIDERS_CONSULCATALOG_ENDPOINT_TLS_CAOPTIONAL:
		'TLS CA.Optional (Default: ```false```)',

	TRAEFIK_PROVIDERS_CONSULCATALOG_ENDPOINT_TLS_CERT: 'TLS cert',

	TRAEFIK_PROVIDERS_CONSULCATALOG_ENDPOINT_TLS_INSECURESKIPVERIFY:
		'TLS insecure skip verify (Default: ```false```)',

	TRAEFIK_PROVIDERS_CONSULCATALOG_ENDPOINT_TLS_KEY: 'TLS key',
	...
	TRAEFIK_PROVIDERS_DOCKER_NETWORK: 'Default Docker network used.',
	...
	TRAEFIK_PROVIDERS_DOCKER_TLS_CA: 'TLS CA',

	TRAEFIK_PROVIDERS_DOCKER_TLS_CAOPTIONAL:
		'TLS CA.Optional (Default: ```false```)',

	TRAEFIK_PROVIDERS_DOCKER_TLS_CERT: 'TLS cert',

	TRAEFIK_PROVIDERS_DOCKER_TLS_INSECURESKIPVERIFY:
		'TLS insecure skip verify (Default: ```false```)',

	TRAEFIK_PROVIDERS_DOCKER_TLS_KEY: 'TLS key',
	...
	TRAEFIK_PROVIDERS_FILE_FILENAME: 'Load dynamic configuration from a file.',

	TRAEFIK_PROVIDERS_FILE_WATCH: 'Watch provider. (Default: ```true```)',
	...
	TRAEFIK_PROVIDERS_KUBERNETESCRD_NAMESPACES: 'Kubernetes namespaces.',
	...
	TRAEFIK_PROVIDERS_MARATHON_TLS_CA: 'TLS CA',

	TRAEFIK_PROVIDERS_MARATHON_TLS_CAOPTIONAL:
		'TLS CA.Optional (Default: ```false```)',

	TRAEFIK_PROVIDERS_MARATHON_TLS_CERT: 'TLS cert',

	TRAEFIK_PROVIDERS_MARATHON_TLS_INSECURESKIPVERIFY:
		'TLS insecure skip verify (Default: ```false```)',

	TRAEFIK_PROVIDERS_MARATHON_TLS_KEY: 'TLS key',

	TRAEFIK_PROVIDERS_MARATHON_TRACE:
		'Display additional provider logs. (Default: ```false```)',

	TRAEFIK_PROVIDERS_MARATHON_WATCH: 'Watch provider. (Default: ```true```)',
	...
	TRAEFIK_PROVIDERS_RANCHER_WATCH: 'Watch provider. (Default: ```true```)',
	...
	TRAEFIK_TRACING: 'OpenTracing configuration. (Default: ```false```)',

	TRAEFIK_TRACING_DATADOG: 'Settings for Datadog. (Default: ```false```)',

	TRAEFIK_TRACING_DATADOG_BAGAGEPREFIXHEADERNAME:
		'Specifies the header name prefix that will be used to store baggage items in a map.',

	TRAEFIK_TRACING_DATADOG_DEBUG: 'Enable Datadog debug. (Default: ```false```)',
	...
	TRAEFIK_TRACING_HAYSTACK: 'Settings for Haystack. (Default: ```false```)',
	...
	TRAEFIK_TRACING_INSTANA: 'Settings for Instana. (Default: ```false```)',
	...
	TRAEFIK_TRACING_JAEGER: 'Settings for Jaeger. (Default: ```false```)',
	...
	TRAEFIK_TRACING_ZIPKIN: 'Settings for Zipkin. (Default: ```false```)',
